...
#define HIDD_BTDM_MODE	0x03		// Bluetooth duel mode. This may be needed for iPhone AND pixel
									// In my testing iPhone13=BLE Pixel7->Classic
// Using duel mode
#define HID_DEV_MODE	HIDD_BTDM_MODE	// Using dual mode
